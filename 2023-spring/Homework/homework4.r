...
## 1.
## Import the UBC Garbage study data set: https://raw.githubusercontent.com/orban-classroom/Statistics-with-R/master/2019%20Spring/data/ubcgarbage/garbage_disposal.csv
## The study describes people throwing away garbage in a sustainable and a non-sustainable building.
## 

code goes here, delete this remark

## 2. 
## Create two filtered variables showing "proportion_correct" values, based on each condition of the study using the "condition" column.
## 
