...
# Compute the mean of the examdata data set manually, using the formula.


# Compute the mean of the examdata data using the R function. 


# Compute the median of examdata using the R function. 


# Compute the mode of each of the two variables in the vector.
# Use multiple different bin sizes to characterize the mode.

# What is the minimum value in this data set?
